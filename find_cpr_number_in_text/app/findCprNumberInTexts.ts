...
const text1 = "Invalid CPR numbers: 320199-1234 and 31 02 31 1234.";
console.log(findCprNumbers(text1)); // Output: []

const text2 = "There are no CPR numbers here.";
console.log(findCprNumbers(text2)); // Output: []

const text3 = "Mixed cases: 010203-1234, 3201991234, and 0405061234.";
